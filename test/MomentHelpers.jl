...
function checkequality(indices, supposed_indices, values, supposed_values, exact::Bool=false)
...
macro checkequals(lowerind, lowerval, upperind, upperval, fullind, fullval)
    esc(quote
        if tri === :L
            @test checkequality(iter[1][1], $lowerind, iter[1][2], $lowerval)
        elseif tri === :U
            @test checkequality(iter[1][1], $upperind, iter[1][2], $upperval)
        else
            @test checkequality(iter[1][1], $fullind, iter[1][2], $fullval, true)
        end
...
Solver.add_constr_nonnegative!(state::SolverSetup{true,false,false,false,false}, indices::AbstractVector{BigInt}, values::AbstractVector{BigFloat}) =
    @interpret add_constr_nonnegative_worker!(state, indices, values)

function add_constr_nonnegative_worker!(state::SolverSetup{true,false,false,false,false}, indices::AbstractVector{BigInt}, values::AbstractVector{BigFloat})
    @test length(indices) == length(values)
    @test state.lastcall === :none
    state.lastcall = :linear
    if state.instance == 1
        @test checkequality(indices, BigInt[20842], values, BigFloat[17], true)
    elseif state.instance == 2
        @test checkequality(indices, BigInt[17827], values, BigFloat[24], true)
    elseif state.instance == 3
        @test checkequality(indices, BigInt[5684,17833], values, BigFloat[2,8], true)
    elseif state.instance == 4
        @test checkequality(indices, BigInt[4736], values, BigFloat[6], true)
    elseif state.instance == 5
        @test checkequality(indices, BigInt[17668], values, BigFloat[14], true)
    elseif state.instance == 6
        @test checkequality(indices, BigInt[4736,4737,5684,9383,17666,17833], values, BigFloat[8,16,3,4,14,5], true)
    elseif state.instance == 7
        @test checkequality(indices, BigInt[20830], values, BigFloat[17], true)
    elseif state.instance == 8
        @test checkequality(indices, BigInt[17744], values, BigFloat[24], true)
    elseif state.instance == 9
        @test checkequality(indices, BigInt[5672,17777], values, BigFloat[2,8], true)
    elseif state.instance == 10
        @test checkequality(indices, BigInt[4699], values, BigFloat[6], true)
    elseif state.instance == 11
        @test checkequality(indices, BigInt[17502], values, BigFloat[14], true)
    elseif state.instance == 12
        @test checkequality(indices, BigInt[4699,4702,5672,9297,17496,17777], values, BigFloat[8,16,3,4,14,5], true)
    else
        @test false
    end
end

Solver.add_constr_quadratic!(state::SolverSetup{false,true,false,false,false}, indvals::Tuple{AbstractVector{BigInt},AbstractVector{BigFloat}}...) =
    @interpret add_constr_quadratic_worker!(state, indvals...)

function Solver.add_constr_quadratic!(state::SolverSetup{false,true,false,false,false}, indvals::Tuple{AbstractVector{BigInt},AbstractVector{BigFloat}}...)
    @test all(x -> length(x[1]) == length(x[2]), indvals)
    @test state.lastcall === :none
    state.lastcall = :quadratic
    if state.instance == 13
        @test length(indvals) == 3
        @test checkequality(indvals[1][1], BigInt[23048], indvals[1][2], BigFloat[17], true)
        @test checkequality(indvals[2][1], BigInt[169998], indvals[2][2], BigFloat[17], true)
        @test checkequality(indvals[3][1], BigInt[68265], indvals[3][2], BigFloat[24.041630560342618])
    elseif state.instance == 15
        @test length(indvals) == 3
        @test checkequality(indvals[1][1], BigInt[21922], indvals[1][2], BigFloat[24], true)
        @test checkequality(indvals[2][1], BigInt[151422], indvals[2][2], BigFloat[24], true)
        @test checkequality(indvals[3][1], BigInt[63204], indvals[3][2], BigFloat[33.941125496954285])
    elseif state.instance == 17
        @test length(indvals) == 3
        @test checkequality(indvals[1][1], BigInt[6223,21928], indvals[1][2], BigFloat[2,8], true)
        @test checkequality(indvals[2][1], BigInt[63728,151428], indvals[2][2], BigFloat[2,8], true)
        @test checkequality(indvals[3][1], BigInt[22426,63210], indvals[3][2], BigFloat[2.8284271247461903,11.313708498984761])
    elseif state.instance == 19
        @test length(indvals) == 3
        @test checkequality(indvals[1][1], BigInt[5815], indvals[1][2], BigFloat[6], true)
        @test checkequality(indvals[2][1], BigInt[55255], indvals[2][2], BigFloat[6], true)
        @test checkequality(indvals[3][1], BigInt[20441], indvals[3][2], BigFloat[8.485281374238571])
    elseif state.instance == 21
        @test length(indvals) == 3
        @test checkequality(indvals[1][1], BigInt[21232], indvals[1][2], BigFloat[14], true)
        @test checkequality(indvals[2][1], BigInt[150102], indvals[2][2], BigFloat[14], true)
        @test checkequality(indvals[3][1], BigInt[62324], indvals[3][2], BigFloat[19.79898987322333])
    elseif state.instance == 23
        @test length(indvals) == 3
        @test checkequality(indvals[1][1], BigInt[5815,5816,6223,11399,21230,21928], indvals[1][2], BigFloat[8,16,3,4,14,5], true)
        @test checkequality(indvals[2][1], BigInt[55255,55256,63728,92459,150100,151428], indvals[2][2], BigFloat[8,16,3,4,14,5], true)
        @test checkequality(indvals[3][1], BigInt[20441,20442,22426,36378,62322,63210], indvals[3][2], BigFloat[11.313708498984761,22.627416997969522,4.242640687119286,5.656854249492381,19.79898987322333,7.0710678118654755])
    elseif state.instance == 25
        @test length(indvals) == 4
        @test checkequality(indvals[1][1], BigInt[20830], indvals[1][2], BigFloat[17], true)
        @test checkequality(indvals[2][1], BigInt[23048], indvals[2][2], BigFloat[17], true)
        @test checkequality(indvals[3][1], BigInt[22409], indvals[3][2], BigFloat[24.041630560342618])
        @test checkequality(indvals[4][1], BigInt[22410], indvals[4][2], BigFloat[-24.041630560342618])
    elseif state.instance == 28
        @test length(indvals) == 4
        @test checkequality(indvals[1][1], BigInt[17744], indvals[1][2], BigFloat[24], true)
        @test checkequality(indvals[2][1], BigInt[21922], indvals[2][2], BigFloat[24], true)
        @test checkequality(indvals[3][1], BigInt[20571], indvals[3][2], BigFloat[33.941125496954285])
        @test checkequality(indvals[4][1], BigInt[20574], indvals[4][2], BigFloat[-33.941125496954285])
    elseif state.instance == 31
        @test length(indvals) == 4
        @test checkequality(indvals[1][1], BigInt[5672,17777], indvals[1][2], BigFloat[2,8], true)
        @test checkequality(indvals[2][1], BigInt[6223,21928], indvals[2][2], BigFloat[2,8], true)
        @test checkequality(indvals[3][1], BigInt[6102,20588], indvals[3][2], BigFloat[2.8284271247461903,11.313708498984761])
        @test checkequality(indvals[4][1], BigInt[6103,20589], indvals[4][2], BigFloat[-2.8284271247461903,-11.313708498984761])
    elseif state.instance == 34
        @test length(indvals) == 4
        @test checkequality(indvals[1][1], BigInt[4699], indvals[1][2], BigFloat[6], true)
        @test checkequality(indvals[2][1], BigInt[5815], indvals[2][2], BigFloat[6], true)
        @test checkequality(indvals[3][1], BigInt[5542,5545], indvals[3][2], BigFloat[4.242640687119286,4.242640687119286])
        @test checkequality(indvals[4][1], BigInt[5546], indvals[4][2], BigFloat[-4.242640687119286])
    elseif state.instance == 37
        @test length(indvals) == 4
        @test checkequality(indvals[1][1], BigInt[17502], indvals[1][2], BigFloat[14], true)
        @test checkequality(indvals[2][1], BigInt[21232], indvals[2][2], BigFloat[14], true)
        @test checkequality(indvals[3][1], BigInt[20164,20168], indvals[3][2], BigFloat[-9.899494936611665,9.899494936611665])
        @test checkequality(indvals[4][1], BigInt[20154,20162], indvals[4][2], BigFloat[9.899494936611665,-9.899494936611665])
    elseif state.instance == 40
        @test length(indvals) == 4
        @test checkequality(indvals[1][1], BigInt[4699,4702,5672,9297,17496,17777], indvals[1][2], BigFloat[8,16,3,4,14,5], true)
        @test checkequality(indvals[2][1], BigInt[5815,5816,6223,11399,21230,21928], indvals[2][2], BigFloat[8,16,3,4,14,5], true)
        @test checkequality(indvals[3][1], BigInt[5542,5545,5546,6102,10837,20156,20166,20588], indvals[3][2], BigFloat[5.656854249492381,5.656854249492381,11.313708498984761,4.242640687119286,5.656854249492381,9.899494936611665,9.899494936611665,7.0710678118654755])
        @test checkequality(indvals[4][1], BigInt[5542,5545,5546,6103,10843,20171,20174,20589], indvals[4][2], BigFloat[11.313708498984761,-11.313708498984761,-5.656854249492381,-4.242640687119286,-5.656854249492381,9.899494936611665,-9.899494936611665,-7.0710678118654755])
    elseif state.instance == 43
        @test length(indvals) == 3
        @test checkequality(indvals[1][1], BigInt[31799], indvals[1][2], BigFloat[17], true)
        @test checkequality(indvals[2][1], BigInt[17770], indvals[2][2], BigFloat[6], true)
        @test checkequality(indvals[3][1], BigInt[9460], indvals[3][2], BigFloat[11.313708498984761])
    ...
    elseif state.instance == 48
        ...
        @test checkequality(indvals[1][1], BigInt[31799], indvals[1][2], BigFloat[17], true)
        @test checkequality(indvals[2][1], BigInt[17770], indvals[2][2], BigFloat[6], true)
        @test checkequality(indvals[3][1], BigInt[9278], indvals[3][2], BigFloat[11.313708498984761])
        @test checkequality(indvals[4][1], BigInt[9280], indvals[4][2], BigFloat[-11.313708498984761])
    elseif state.instance == 51
        @test length(indvals) == 4
        @test checkequality(indvals[1][1], BigInt[31799], indvals[1][2], BigFloat[17], true)
        @test checkequality(indvals[2][1], BigInt[17770], indvals[2][2], BigFloat[6], true)
        @test checkequality(indvals[3][1], BigInt[9280], indvals[3][2], BigFloat[11.313708498984761])
        @test checkequality(indvals[4][1], BigInt[9278], indvals[4][2], BigFloat[11.313708498984761])
    elseif state.instance == 54
        @test length(indvals) == 4
        @test checkequality(indvals[1][1], BigInt[31799], indvals[1][2], BigFloat[17], true)
        @test checkequality(indvals[2][1], BigInt[17770], indvals[2][2], BigFloat[6], true)
        @test checkequality(indvals[3][1], BigInt[9278,9280], indvals[3][2], BigFloat[11.313708498984761,2.8284271247461903])
        @test checkequality(indvals[4][1], BigInt[9278,9280], indvals[4][2], BigFloat[2.8284271247461903,-11.313708498984761])
    elseif state.instance == 57
        @test length(indvals) == 4
        @test checkequality(indvals[1][1], BigInt[9460,31799], indvals[1][2], BigFloat[5,17], true)
        @test checkequality(indvals[2][1], BigInt[17770], indvals[2][2], BigFloat[6], true)
        @test checkequality(indvals[3][1], BigInt[9280,9297], indvals[3][2], BigFloat[2.8284271247461903,1.4142135623730951])
        @test checkequality(indvals[4][1], BigInt[5665,9278,9280], indvals[4][2], BigFloat[-4.242640687119286,-2.8284271247461903,22.627416997969522])
    elseif state.instance == 60
        @test length(indvals) == 3
        @test checkequality(indvals[1][1], BigInt[17669,17845], indvals[1][2], BigFloat[-34,10], true)
        @test checkequality(indvals[2][1], BigInt[17770], indvals[2][2], BigFloat[6], true)
        @test checkequality(indvals[3][1], BigInt[9278,9280], indvals[3][2], BigFloat[22.627416997969522,5.656854249492381])
    else
        @test false
    end
end
...
Solver.add_constr_fix!(state::SolverSetup{false,false,false,false,true}, constrstate::UInt, indices::AbstractVector{BigInt}, values::AbstractVector{BigFloat}, rhs::BigFloat) =
    @interpret add_constr_fix_helper!(state, constrstate, indices, values, rhs)

function add_constr_fix_helper!(state::SolverSetup{false,false,false,false,true}, constrstate::UInt, indices::AbstractVector{BigInt}, values::AbstractVector{BigFloat}, rhs::BigFloat)
    @test in(state.lastcall, (:add_constr_fix_prepare, :add_constr_fix))
    state.lastcall = :add_constr_fix
    @test iszero(rhs)
    if state.instance == 72
        if checkequality(indices, BigInt[57], values, BigFloat[5], true)
            pop!(state.fixed_available, UInt(1))
        elseif checkequality(indices, BigInt[93], values, BigFloat[5], true)
            pop!(state.fixed_available, UInt(2))
        elseif checkequality(indices, BigInt[213], values, BigFloat[5], true)
            pop!(state.fixed_available, UInt(3))
        end
    elseif state.instance == 73
        if checkequality(indices, BigInt[57], values, BigFloat[5], true)
            pop!(state.fixed_available, UInt(1))
        elseif checkequality(indices, BigInt[88], values, BigFloat[5], true)
            pop!(state.fixed_available, UInt(2))
        elseif checkequality(indices, BigInt[89], values, BigFloat[5], true)
            pop!(state.fixed_available, UInt(3))
        elseif checkequality(indices, BigInt[186], values, BigFloat[5], true)
            pop!(state.fixed_available, UInt(4))
        end
    elseif state.instance == 74
        if checkequality(indices, BigInt[52,53], values, BigFloat[12,-16], true)
            pop!(state.fixed_available, UInt(1))
        elseif checkequality(indices, BigInt[88,89], values, BigFloat[12,-16], true)
            pop!(state.fixed_available, UInt(2))
        elseif checkequality(indices, BigInt[208,209], values, BigFloat[12,-16], true)
            pop!(state.fixed_available, UInt(3))
        end
    elseif state.instance == 75
        if checkequality(indices, BigInt[52,53], values, BigFloat[12,-16], true)
            pop!(state.fixed_available, UInt(1))
        elseif checkequality(indices, BigInt[63,66,67], values, BigFloat[6,6,-8], true)
            pop!(state.fixed_available, UInt(2))
        elseif checkequality(indices, BigInt[63,66,67], values, BigFloat[8,-8,6], true)
            pop!(state.fixed_available, UInt(3))
        elseif checkequality(indices, BigInt[109,112], values, BigFloat[12,-16], true)
            pop!(state.fixed_available, UInt(4))
        end
    elseif state.instance == 76
        if checkequality(indices, BigInt[52,53], values, BigFloat[12,-16], true)
            pop!(state.fixed_available, UInt(1))
        elseif checkequality(indices, BigInt[61,62,64,65], values, BigFloat[6,6,-8,-8], true)
            pop!(state.fixed_available, UInt(2))
        elseif checkequality(indices, BigInt[61,62,64,65], values, BigFloat[8,-8,-6,6], true)
            pop!(state.fixed_available, UInt(3))
        elseif checkequality(indices, BigInt[99,105], values, BigFloat[12,-16], true)
            pop!(state.fixed_available, UInt(4))
        end
    elseif state.instance == 77
        if checkequality(indices, BigInt[52,53], values, BigFloat[6,-8], true)
            pop!(state.fixed_available, UInt(1))
        elseif checkequality(indices, BigInt[52,53], values, BigFloat[8,6], true)
            pop!(state.fixed_available, UInt(2))
        elseif checkequality(indices, BigInt[88,89], values, BigFloat[6,-8], true)
            pop!(state.fixed_available, UInt(3))
        elseif checkequality(indices, BigInt[88,89], values, BigFloat[8,6], true)
            pop!(state.fixed_available, UInt(4))
        elseif checkequality(indices, BigInt[208,209], values, BigFloat[6,-8], true)
            pop!(state.fixed_available, UInt(5))
        elseif checkequality(indices, BigInt[208,209], values, BigFloat[8,6], true)
    ...
    elseif state.instance == 78
        ...
        elseif checkequality(indices, BigInt[52,53], values, BigFloat[8,6], true)
            pop!(state.fixed_available, UInt(2))
        elseif checkequality(indices, BigInt[63,67], values, BigFloat[6,-8], true)
            pop!(state.fixed_available, UInt(3))
        elseif checkequality(indices, BigInt[63,67], values, BigFloat[8,6], true)
            pop!(state.fixed_available, UInt(4))
        elseif checkequality(indices, BigInt[66], values, BigFloat[6], true)
            pop!(state.fixed_available, UInt(5))
        elseif checkequality(indices, BigInt[66], values, BigFloat[8], true)
            pop!(state.fixed_available, UInt(6))
        elseif checkequality(indices, BigInt[109,112], values, BigFloat[6,-8], true)
            pop!(state.fixed_available, UInt(7))
        elseif checkequality(indices, BigInt[109,112], values, BigFloat[8,6], true)
    ...
    elseif state.instance == 79
        ...
        elseif checkequality(indices, BigInt[52,53], values, BigFloat[8,6], true)
            pop!(state.fixed_available, UInt(2))
        elseif checkequality(indices, BigInt[61,65], values, BigFloat[6,-8], true)
            pop!(state.fixed_available, UInt(3))
        elseif checkequality(indices, BigInt[61,65], values, BigFloat[8,6], true)
            pop!(state.fixed_available, UInt(4))
        elseif checkequality(indices, BigInt[62,64], values, BigFloat[6,-8], true)
            pop!(state.fixed_available, UInt(5))
        elseif checkequality(indices, BigInt[62,64], values, BigFloat[8,6], true)
            pop!(state.fixed_available, UInt(6))
        elseif checkequality(indices, BigInt[99,105], values, BigFloat[6,-8], true)
            pop!(state.fixed_available, UInt(7))
        elseif checkequality(indices, BigInt[99,105], values, BigFloat[8,6], true)
            pop!(state.fixed_available, UInt(8))
        end
    elseif state.instance == 80
        if checkequality(indices, BigInt[57], values, BigFloat[6], true)
            pop!(state.fixed_available, UInt(1))
        end
    elseif state.instance == 81
        if checkequality(indices, BigInt[52,53], values, BigFloat[12,8], true)
            pop!(state.fixed_available, UInt(1))
        end
    elseif state.instance == 82
        if checkequality(indices, BigInt[52,53], values, BigFloat[6,4], true)
            pop!(state.fixed_available, UInt(1))
        elseif checkequality(indices, BigInt[52,53], values, BigFloat[4,-6], true)
            pop!(state.fixed_available, UInt(2))
        end
    elseif state.instance == 83
        if checkequality(indices, BigInt[52,53], values, BigFloat[14,4], true)
            pop!(state.fixed_available, UInt(1))
        elseif checkequality(indices, BigInt[52,53,55], values, BigFloat[4,2,2], true)
            pop!(state.fixed_available, UInt(2))
        end
    elseif state.instance == 84
        if checkequality(indices, BigInt[49,58,59], values, BigFloat[-10,-4,8], true)
            pop!(state.fixed_available, UInt(1))
        end
    ...
    elseif state.instance == 90
        if checkequality(indices, BigInt[57], values, BigFloat[6], true)
            pop!(state.fixed_available, UInt(1))
        elseif checkequality(indices, BigInt[93], values, BigFloat[6], true)
            pop!(state.fixed_available, UInt(2))
        elseif checkequality(indices, BigInt[205], values, BigFloat[6], true)
            pop!(state.fixed_available, UInt(3))
        elseif checkequality(indices, BigInt[213], values, BigFloat[6], true)
            pop!(state.fixed_available, UInt(4))
        elseif checkequality(indices, BigInt[535], values, BigFloat[6], true)
            pop!(state.fixed_available, UInt(5))
        elseif checkequality(indices, BigInt[1215], values, BigFloat[6], true)
            pop!(state.fixed_available, UInt(6))
        end
    elseif state.instance == 91
        if checkequality(indices, BigInt[52,53], values, BigFloat[12,8], true)
            pop!(state.fixed_available, UInt(1))
        elseif checkequality(indices, BigInt[88,89], values, BigFloat[12,8], true)
            pop!(state.fixed_available, UInt(2))
        elseif checkequality(indices, BigInt[173,174], values, BigFloat[12,8], true)
            pop!(state.fixed_available, UInt(3))
        elseif checkequality(indices, BigInt[208,209], values, BigFloat[12,8], true)
            pop!(state.fixed_available, UInt(4))
        elseif checkequality(indices, BigInt[503,504], values, BigFloat[12,8], true)
            pop!(state.fixed_available, UInt(5))
        elseif checkequality(indices, BigInt[1001,1002], values, BigFloat[12,8], true)
            pop!(state.fixed_available, UInt(6))
        end
    elseif state.instance == 92
        ...
        elseif checkequality(indices, BigInt[52,53], values, BigFloat[4,-6], true)
            pop!(state.fixed_available, UInt(2))
        elseif checkequality(indices, BigInt[88,89], values, BigFloat[6,4], true)
            pop!(state.fixed_available, UInt(3))
        elseif checkequality(indices, BigInt[88,89], values, BigFloat[4,-6], true)
            pop!(state.fixed_available, UInt(4))
        elseif checkequality(indices, BigInt[173,174], values, BigFloat[6,4], true)
            pop!(state.fixed_available, UInt(5))
        elseif checkequality(indices, BigInt[173,174], values, BigFloat[4,-6], true)
            pop!(state.fixed_available, UInt(6))
        elseif checkequality(indices, BigInt[208,209], values, BigFloat[6,4], true)
            pop!(state.fixed_available, UInt(7))
        elseif checkequality(indices, BigInt[208,209], values, BigFloat[4,-6], true)
            pop!(state.fixed_available, UInt(8))
        elseif checkequality(indices, BigInt[503,504], values, BigFloat[6,4], true)
            pop!(state.fixed_available, UInt(9))
        elseif checkequality(indices, BigInt[503,504], values, BigFloat[4,-6], true)
            pop!(state.fixed_available, UInt(10))
        elseif checkequality(indices, BigInt[1001,1002], values, BigFloat[6,4], true)
            pop!(state.fixed_available, UInt(11))
        elseif checkequality(indices, BigInt[1001,1002], values, BigFloat[4,-6], true)
    ...
    elseif state.instance == 93
        ...
        elseif checkequality(indices, BigInt[52,53,55], values, BigFloat[4,2,2], true)
            pop!(state.fixed_available, UInt(2))
        elseif checkequality(indices, BigInt[88,89], values, BigFloat[14,4], true)
            pop!(state.fixed_available, UInt(3))
        elseif checkequality(indices, BigInt[88,89,91], values, BigFloat[4,2,2], true)
            pop!(state.fixed_available, UInt(4))
        elseif checkequality(indices, BigInt[173,174], values, BigFloat[14,4], true)
            pop!(state.fixed_available, UInt(5))
        elseif checkequality(indices, BigInt[173,174,176], values, BigFloat[4,2,2], true)
            pop!(state.fixed_available, UInt(6))
        elseif checkequality(indices, BigInt[208,209], values, BigFloat[14,4], true)
            pop!(state.fixed_available, UInt(7))
        elseif checkequality(indices, BigInt[208,209,211], values, BigFloat[4,2,2], true)
            pop!(state.fixed_available, UInt(8))
        elseif checkequality(indices, BigInt[503,504], values, BigFloat[14,4], true)
            pop!(state.fixed_available, UInt(9))
        elseif checkequality(indices, BigInt[503,504,506], values, BigFloat[4,2,2], true)
            pop!(state.fixed_available, UInt(10))
        elseif checkequality(indices, BigInt[1001,1002], values, BigFloat[14,4], true)
            pop!(state.fixed_available, UInt(11))
        elseif checkequality(indices, BigInt[1001,1002,1004], values, BigFloat[4,2,2], true)
            pop!(state.fixed_available, UInt(12))
        end
    elseif state.instance == 94
        if checkequality(indices, BigInt[49,58,59], values, BigFloat[-10,-4,8], true)
            pop!(state.fixed_available, UInt(1))
        elseif checkequality(indices, BigInt[57,178,179], values, BigFloat[-10,-4,8], true)
            pop!(state.fixed_available, UInt(2))
        elseif checkequality(indices, BigInt[85,396,397], values, BigFloat[-10,-4,8], true)
            pop!(state.fixed_available, UInt(3))
        elseif checkequality(indices, BigInt[93,508,509], values, BigFloat[-10,-4,8], true)
            pop!(state.fixed_available, UInt(4))
        elseif checkequality(indices, BigInt[205,1188,1189], values, BigFloat[-10,-4,8], true)
            pop!(state.fixed_available, UInt(5))
        elseif checkequality(indices, BigInt[423,2232,2233], values, BigFloat[-10,-4,8], true)
            pop!(state.fixed_available, UInt(6))
        end
    elseif state.instance == 95
        ...
        elseif checkequality(indices, BigInt[93], values, BigFloat[6], true)
            pop!(state.fixed_available, UInt(2))
        elseif checkequality(indices, BigInt[178], values, BigFloat[6], true)
            pop!(state.fixed_available, UInt(3))
        elseif checkequality(indices, BigInt[180], values, BigFloat[6], true)
            pop!(state.fixed_available, UInt(4))
        elseif checkequality(indices, BigInt[213], values, BigFloat[6], true)
            pop!(state.fixed_available, UInt(5))
        elseif checkequality(indices, BigInt[508], values, BigFloat[6], true)
            pop!(state.fixed_available, UInt(6))
        elseif checkequality(indices, BigInt[510], values, BigFloat[6], true)
            pop!(state.fixed_available, UInt(7))
        elseif checkequality(indices, BigInt[1008], values, BigFloat[6], true)
            pop!(state.fixed_available, UInt(8))
        end
    elseif state.instance == 96
        ...
        elseif checkequality(indices, BigInt[88,89], values, BigFloat[12,8], true)
            pop!(state.fixed_available, UInt(2))
        elseif checkequality(indices, BigInt[98,100,104,106], values, BigFloat[6,6,4,4], true)
            pop!(state.fixed_available, UInt(3))
        elseif checkequality(indices, BigInt[98,100,104,106], values, BigFloat[-4,4,-6,6], true)
            pop!(state.fixed_available, UInt(4))
        elseif checkequality(indices, BigInt[208,209], values, BigFloat[12,8], true)
            pop!(state.fixed_available, UInt(5))
        elseif checkequality(indices, BigInt[428,430,434,436], values, BigFloat[6,6,4,4], true)
            pop!(state.fixed_available, UInt(6))
        elseif checkequality(indices, BigInt[428,430,434,436], values, BigFloat[-4,4,-6,6], true)
            pop!(state.fixed_available, UInt(7))
        elseif checkequality(indices, BigInt[552,567], values, BigFloat[12,8], true)
            pop!(state.fixed_available, UInt(8))
        end
    elseif state.instance == 97
        ...
        elseif checkequality(indices, BigInt[88,89], values, BigFloat[4,-6], true)
            pop!(state.fixed_available, UInt(4))
        elseif checkequality(indices, BigInt[100,104], values, BigFloat[6,4], true)
            pop!(state.fixed_available, UInt(5))
        elseif checkequality(indices, BigInt[100,104], values, BigFloat[4,-6], true)
            pop!(state.fixed_available, UInt(6))
        elseif checkequality(indices, BigInt[98,106], values, BigFloat[6,4], true)
            pop!(state.fixed_available, UInt(7))
        elseif checkequality(indices, BigInt[98,106], values, BigFloat[4,-6], true)
            pop!(state.fixed_available, UInt(8))
        elseif checkequality(indices, BigInt[208,209], values, BigFloat[6,4], true)
            pop!(state.fixed_available, UInt(9))
        elseif checkequality(indices, BigInt[208,209], values, BigFloat[4,-6], true)
            pop!(state.fixed_available, UInt(10))
        elseif checkequality(indices, BigInt[430,434], values, BigFloat[6,4], true)
            pop!(state.fixed_available, UInt(11))
        elseif checkequality(indices, BigInt[430,434], values, BigFloat[4,-6], true)
            pop!(state.fixed_available, UInt(12))
        elseif checkequality(indices, BigInt[428,436], values, BigFloat[6,4], true)
            pop!(state.fixed_available, UInt(13))
        elseif checkequality(indices, BigInt[428,436], values, BigFloat[4,-6], true)
            pop!(state.fixed_available, UInt(14))
        elseif checkequality(indices, BigInt[552,567], values, BigFloat[6,4], true)
            pop!(state.fixed_available, UInt(15))
        elseif checkequality(indices, BigInt[552,567], values, BigFloat[4,-6], true)
    ...
    elseif state.instance == 98
        ...
        elseif checkequality(indices, BigInt[88,89,91], values, BigFloat[4,2,2], true)
            pop!(state.fixed_available, UInt(4))
        elseif checkequality(indices, BigInt[98,100,104,131], values, BigFloat[8,6,4,-2], true)
            pop!(state.fixed_available, UInt(5))
        elseif checkequality(indices, BigInt[100,104,106,129], values, BigFloat[4,-6,8,2], true)
            pop!(state.fixed_available, UInt(6))
        elseif checkequality(indices, BigInt[98,100,106,131], values, BigFloat[6,8,4,2], true)
            pop!(state.fixed_available, UInt(7))
        elseif checkequality(indices, BigInt[98,104,106,129], values, BigFloat[4,8,-6,2], true)
            pop!(state.fixed_available, UInt(8))
        elseif checkequality(indices, BigInt[208,209], values, BigFloat[14,4], true)
            pop!(state.fixed_available, UInt(9))
        elseif checkequality(indices, BigInt[208,209,211], values, BigFloat[4,2,2], true)
            pop!(state.fixed_available, UInt(10))
        elseif checkequality(indices, BigInt[428,430,434,461], values, BigFloat[8,6,4,-2], true)
            pop!(state.fixed_available, UInt(11))
        elseif checkequality(indices, BigInt[430,434,436,459], values, BigFloat[4,-6,8,2], true)
            pop!(state.fixed_available, UInt(12))
        elseif checkequality(indices, BigInt[428,430,436,461], values, BigFloat[6,8,4,2], true)
            pop!(state.fixed_available, UInt(13))
        elseif checkequality(indices, BigInt[428,434,436,459], values, BigFloat[4,8,-6,2], true)
            pop!(state.fixed_available, UInt(14))
        elseif checkequality(indices, BigInt[552,567], values, BigFloat[14,4], true)
            pop!(state.fixed_available, UInt(15))
        elseif checkequality(indices, BigInt[552,567,672], values, BigFloat[4,2,2], true)
            pop!(state.fixed_available, UInt(16))
        end
    elseif state.instance == 99
        ...
        elseif checkequality(indices, BigInt[57,178,179], values, BigFloat[-10,-4,8], true)
            pop!(state.fixed_available, UInt(2))
        elseif checkequality(indices, BigInt[58,214,215,216], values, BigFloat[-10,-2,8,-2], true)
            pop!(state.fixed_available, UInt(3))
        elseif checkequality(indices, BigInt[60,217,218], values, BigFloat[-10,8,-2], true)
            pop!(state.fixed_available, UInt(4))
        elseif checkequality(indices, BigInt[93,508,509], values, BigFloat[-10,-4,8], true)
            pop!(state.fixed_available, UInt(5))
        elseif checkequality(indices, BigInt[178,1006,1007,1008], values, BigFloat[-10,-2,8,-2], true)
            pop!(state.fixed_available, UInt(6))
        elseif checkequality(indices, BigInt[180,1009,1010], values, BigFloat[-10,8,-2], true)
            pop!(state.fixed_available, UInt(7))
        elseif checkequality(indices, BigInt[216,1338,1339], values, BigFloat[-10,-4,8], true)
            pop!(state.fixed_available, UInt(8))
        end
    end
