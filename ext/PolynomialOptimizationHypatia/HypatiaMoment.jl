...
Solver.extract_sos(::AbstractRelaxation, (state, solver)::Tuple{StateMoment,Any}, ::Val{:slack}, index::AbstractUnitRange,
    ::Nothing) = get_slack(state, Solvers.get_x(solver), index)
